                        ...
                        <form action="{{ url('families/' . $families->id) }}" method="POST">
                                ...
                                <select name="place_id" id="" class="form-control">
                                    ...
                                    @foreach ($places as $place)
                                        <option value="{{ $place->id }}"
                                            {{ $families->place_id == $place->id ? 'selected' : '' }}>{{ $place->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_father" class="form-control"
                                    value="{{ $families->name_father }}">
                            </div>
                            <div class="mb-3">
                                <label for="phone">Phone :</label>
                                <input type="text" name="phone" value="{{ $families->phone }}" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="national_no">National No :</label>
                                <input type="text" name="national_no" value="{{ $families->national_no }}"
                                    class="form-control">
                            </div>
